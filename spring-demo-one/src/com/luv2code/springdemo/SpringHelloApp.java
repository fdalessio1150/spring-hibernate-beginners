...
// Principal vantagem -> N�o precisamos modificar o source code compilado, apenas o arquivo de configuracao
...
public class SpringHelloApp {
	...
	public static void main(String[] args) {
		...
		// Carrega o arquivo contendo todas as refer�ncias de beans/objetos que devem ser criadas
		...
		// A interface so exibe o que est� disponivel, por isso temos que criar a bean/objeto de uma classe que implementa ela
